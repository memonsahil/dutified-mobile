...
const SearchScreen = () => {
  ...
  useEffect(() => {
    if (searchText !== "") {
      ...
      Promise.all([getProjectResults(searchText), getJobResults(searchText)])
        .then((results) => {
        ...
        {searchText === "" ? (
          <View style={styles.noDataContainer}>
            <Text style={styles.noDataText}>
              Search for projects and jobs by their name or category.
            </Text>
          </View>
        ) : (
          <>
            {loading !== true ? (
              <>
                {projects.length === 0 && jobs.length === 0 ? (
                  <View style={styles.noDataContainer}>
                    <Text style={styles.noDataHeading}>No Results Found</Text>
                    <Text style={styles.noDataText}>
                      No projects or jobs were found, try searching for
                      something else.
                    </Text>
                  </View>
                ) : null}
