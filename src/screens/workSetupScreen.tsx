...
const WorkSetupScreen = () => {
  ...
  const searchCategories = (
    ...
    for (const category in categories) {
      if (
        categories[category].toLowerCase().includes(searchArg.toLowerCase())
      ) {
      ...
      {loading === false ? (
        ...
        >
          ...
          <Text style={styles.info}>
            Setup your preferred categories and number of jobs that you want to
            work on this month.
          </Text>
          ...
          <View style={styles.searchContainer}>
            <Text style={styles.searchCategoriesHeading}>Options</Text>
            <ScrollView
              horizontal={true}
          ...
          {selectedCategories.length !== 0 ? (
            <View style={styles.selectedContainer}>
              <Text style={styles.selectedCategoriesHeading}>Selected</Text>
              <ScrollView
                horizontal={true}
                showsHorizontalScrollIndicator={false}
                contentContainerStyle={styles.categoriesScrollView}
          ...
          <TouchableOpacity
            ...
            onPress={() => {
              if (selectedCategories.length !== 0 && totalJobs !== "") {
                setLoading(true);

                saveWorkSetup({
                  preferredCategories: selectedCategories,
                  totalJobs: totalJobs.split(".")[0].replace(/,/g, ""),
                })
                  .then(() => {
                    setLoading(false);
