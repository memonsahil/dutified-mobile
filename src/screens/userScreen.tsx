      ...
      {loading === false ? (
        ...
        >
          <View style={styles.headerSection}>
            ...
            <FontAwesome5 name="grin-stars" size={30} color={green} />
          </View>
          <UserCard first={first} last={last} image={imageSrc} />
          {projects.length === 0 ? (
            <View style={styles.noDataContainer}>
              <Text style={styles.noDataHeading}>No Active Projects</Text>
            ...
            <>
              ...
              {jobs.length === 0 ? (
                <View style={styles.noDataContainer}>
                  <Text style={styles.noDataHeading}>No Active Jobs</Text>
                  <Text style={styles.noDataText}>
                    `${first} ${last} has not created or taken up any jobs yet.`
                  </Text>
                </View>
              ) : (
                <>
